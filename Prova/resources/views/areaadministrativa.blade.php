        ...
        <div class="header-body">
          <div class="row align-items-center py-2">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0"></br>Área Administrativa</h6>
            </div>
          </div>
        ...
        <div class="card-body">
          <div class="text-center">
              <a href="{{route('vacinas.index')}}">
                <button class="btn btn-white">Vacinas</button>
              </a>
              <a href="{{route('pessoas.index')}}">
                <button class="btn btn-white">Pessoas</button>
              </a>
              <a href="{{route('unidades.index')}}">
                <button class="btn btn-white">Unidades</button>
              </a>
              <a href="{{route('registros.index')}}">
                <button class="btn btn-white">Registros</button>
              </a>
          </div>
        </div>
      </div>
